...
const { processWriteLog, processCreateSelfLog } = require("../internal/service/logger");
...
consumer.use(EXECUTE_PROBE_WORKER_MQ_QUEUE, ({ probeId }) => processExecuteProbeWorker(probeId));
consumer.start()
