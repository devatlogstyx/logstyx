...
export const WRITE_PROJECT_USER_ROLE = "WRITE_PROJECT"
export const READ_PROJECT_USER_ROLE = "READ_PROJECT"

export const WRITE_SETTINGS_USER_ROLE = "WRITE_SETTINGS"
export const READ_SETTINGS_USER_ROLE = "READ_SETTINGS"