import { JsonInput, Modal, NumberInput, PasswordInput, Select, TextInput, Button, Stepper } from "@mantine/core";
        ...
        >
            <form onSubmit={form.onSubmit(handleSubmit)}>
                <Stepper active={currentStep}  >
                    <Stepper.Step label={`Basic Config`}>
                        <TextInput
                            label="Title"
                    ...
                    <Stepper.Step label={`Setup Conection`}>
                        <Select
                            label="HTTP Method"
