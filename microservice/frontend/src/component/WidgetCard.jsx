...
export default function WidgetCard({ widget, slug, readOnly }) {
  ...
  return (
    <div className="border p-3 rounded">
      <div className="flex items-center justify-between mb-2">
        <div className="font-semibold">{widget.title} <span className="text-xs text-gray-500">({widget.template})</span></div>
        <button className="text-sm text-blue-600" onClick={fetchData}>Refresh</button>
      </div>
